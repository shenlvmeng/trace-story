...
function ForkMe() {
    return (
        <a href="https://github.com/shenlvmeng/trace-story" className="github-corner" aria-label="View source on GitHub">
            <svg width="80" height="80" viewBox="0 0 250 250" style={{fill: '#FD6C6C', color: '#fff', position: 'absolute', top: 0, border: 0, right: 0, zIndex: 2}} aria-hidden="true">
